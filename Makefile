...
$(PROGRAM): clean
	./genh-not-boot-file-name.sh
	mkdir -p $(BUILD_DIR)
	$(COMPILER) $(COMPILER_FLAGS_LIB) -c lib-ppf.c -o $(BUILD_DIR)/lib-ppf.o
	$(AR) rcs $(BUILD_DIR)/libppf.a $(BUILD_DIR)/lib-ppf.o
ifeq ($(strip $(EXECUTABLE_NAME)),)
	$(COMPILER) $(COMPILER_FLAGS) $(SOURCE_FILES) -L./$(BUILD_DIR) -lppf -o $(BUILD_DIR)/$(PROGRAM)
else
	$(COMPILER) $(COMPILER_FLAGS) $(SOURCE_FILES) -L./$(BUILD_DIR) -lppf -o $(BUILD_DIR)/$(EXECUTABLE_NAME)
endif
